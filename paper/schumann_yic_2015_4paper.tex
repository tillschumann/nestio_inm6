...
Taking into account that some of the libraries use parallelized I/O libraries,
...
If the network node is a virtual recording device, it calls writing functions depending on the incomming information.
...
\caption{Input parameters of the NESTProxy. Following distributions are implemented: Standard, Poisson, Binominal and fixed values}
\end{table}
