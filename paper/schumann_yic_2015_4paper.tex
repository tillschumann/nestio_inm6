...
\pleasewrite{Till}{Please add benchmark results here. Short intro text
  plus two plots, one for each benchmark situation, each containing
  three performance curves. Short caption to explain the figures. Write explicitly that the benchmarks were generated on Hambach, give a concise description of this machine, e.g. ``Intel Xeon cluster with xxx compute nodes''.}
...
\pleasewrite{Till}{Please write here something short with summarizes the results
of your figures. And please insert the right reference to your figure just before this pleasewrite.}
...
\pleasewrite{Till}{Single positive sentence about SionLib if the results justify it.}
