...
The synchronization function allows the usage of inter node commuication during runtime.
...
In the update function neurons call their own algorithms, which may contain writing calls.
