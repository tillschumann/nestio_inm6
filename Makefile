...
MPISIONLIB =  `$(SIONCONFIG) --libs --ompi --be --64`
MPISIONCFLAGS = `$(SIONCONFIG) --cflags --ompi --be --64`

SERSIONLIB =  `$(SIONCONFIG) --libs --ser --be --64`
SERSIONCFLAGS = `$(SIONCONFIG) --cflags --ser --be --64`
