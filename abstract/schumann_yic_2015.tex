...
\abstract{NEST \cite{NEST} is a simulator for spiking neural
  ...
  To assess different I/O strategies and libraries, we have implemented a
  ...
  threads, recording rate and spike rate).

  This proxy allows benchmarking and statistical analysis, and
